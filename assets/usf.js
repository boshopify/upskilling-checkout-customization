/* USF file - Do not modify this file since it is regularly changed. Auto modified at: 12/9/2020 11:15:00 PM*/
var _usfImageWidths;
...
<li :class="'grid__item grid__item--collection-template ' + window.usf_gridItemWidth" @mouseover="onItemHover" @mouseleave="onItemLeave" :key="product.id"> 
    <div class="grid-view-item product-card" :class="{'grid-view-item--sold-out': isSoldOut}">
	    ...
	    <dl class="price price--listing" :class="{'price--on-sale': hasDiscount, 'price--sold-out' : isSoldOut}">
	        <!--vendor-->
            <a v-if="usf.settings.search.showVendor && usf_sectionSettings.show_vendor" class="price__vendor price__vendor--listing" :href="usf.platform.baseUrl + '/collections/vendors?q=' + encodeURIComponent(product.vendor)">
              <dt>
            ...
            <div class="price__regular" >
                ...
                <dd>
		            <span class="price-item price-item--regular" v-html="priceVaries ? _usfFrom.replace('{{ lowest_price }}',displayMinPrice) : displayPrice"></span>
                </dd>
            </div>
            <div class="price__sale">
                ...
                <dd>
		            <span class="price-item price-item--sale" v-html="priceVaries ? _usfFrom.replace('{{ lowest_price }}',displayMinDiscountedPrice) : displayDiscountedPrice"></span>
                </dd>
        ...
        <div class="list-view-item__link">
            ...
            <div class="list-view-item__title-column">
                <div class="list-view-item__title" aria-hidden="true">
                    ...
                    <div v-if="usf.settings.search.showVendor && usf_sectionSettings.show_vendor"" class="list-view-item__vendor medium-up--hide" v-html="product.vendor"></div>
                </div>
            </div>
...
usf.event.add('init', function () {
    ...
    window._usfFrom = window._usfFrom || "from {{ lowest_price }}";
